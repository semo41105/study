...
import com.collection.silsub1.controller.BoardManager;
...
public class BoardMenu {
	...
	public void mainMenu() {
		while (true) {
			...
			case 2: bm.displayAllLlist(); break;
	...
	public void sortSubMenu() {
		...
		System.out.println("1. 글 번호순 오름차순 정렬0");
		System.out.println("2. 글 번호순 내림차순 정렬");
		System.out.println("3. 작성날짜순 오름차순 정렬");
		System.out.println("4. 작성날짜순 오름차순 정렬");
		System.out.println("5. 글 제목순 오름차순 정렬0");
